...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Danh Sách Sản Phẩm Theo Danh Mục</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="{{ !empty($_SESSION['url_listCategory']) ? $_SESSION['url_listCategory'] : $_SERVER['REQUEST_URI'] }}" class="btn btn-facebook">Quay lại</a>
            </div>
            <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                @if(!empty($categoryDetail))
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <tbody>
                                        @foreach($categoryDetail as $key => $post)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <a class="btn btn-facebook" href="/admin/posts/detailPost/{{ $post['id_post'] }}">Chi tiết</a>
                                                </td>
                                                <td>
                                ...
                                @else
                                    <div style="display: flex; justify-content: center; align-items: center; height: 300px;">
                                        <h5>Danh mục này chưa có bài viết nào</h5>
                                    </div>
                                @endif
