    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="posts/addPost" class="btn btn-facebook">Thêm mới bài viết</a>
            </div>
            <div class="card-body">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div id="dataTable_filter" class="dataTables_filter">
                                        <label style="display: flex; align-items: center; width: 200%;">
                                            ...
                                            <input type="search" class="form-control form-control-sm" name="search_post" placeholder="Nhập tên bài viết..."
